...
void set_play(Game* game)
{
    ...
    ///////////
    ////////
    /*////ASK ASM ABOUT MODIFYING THIS HERE!!!!
    game->p1.event = g_timeout_add(500, on_key_press, NULL);
    game->p2.event = g_timeout_add(500, on_key_press, NULL);
    game->p1.event = g_timeout_add(500, on_key_release, NULL);
    game->p1.event = g_timeout_add(500, on_key_release, NULL);*/
}
